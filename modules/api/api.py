...
class Api:
    ...
    def download_model(self, model_name: str, model_url: str):
        import gdown
        model_url = 'https://drive.google.com/uc?id=1dovHzQCQYPut7PmKJucLGlV5H4rPZin1'
        output = '/home/user/app/stable-diffusion-webui/models/Stable-diffusion/'+model_name
